...
struct DirectionalLight{
    // vec3 position; // Not needed for directional lighting
    vec3 direction;

    // directional lighting properties
    // attenuation - reduces light tensity over distance per light ray when it travels.
...
void main(){
    ...
    // Adding attenuation
    float dist = length(light.direction - FragPos);
